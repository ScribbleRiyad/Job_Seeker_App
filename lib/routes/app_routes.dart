...
import 'package:application1/presentation/onboarding_one_screen/onboarding_one_screen.dart';
import 'package:application1/presentation/onboarding_two_screen/onboarding_two_screen.dart';
import 'package:application1/presentation/onboarding_three_screen/onboarding_three_screen.dart';
import 'package:application1/presentation/sign_up_create_acount_screen/sign_up_create_acount_screen.dart';
import 'package:application1/presentation/sign_up_complete_account_screen/sign_up_complete_account_screen.dart';
import 'package:application1/presentation/job_type_screen/job_type_screen.dart';
import 'package:application1/presentation/speciallization_screen/speciallization_screen.dart';
import 'package:application1/presentation/select_a_country_screen/select_a_country_screen.dart';
import 'package:application1/presentation/login_screen/login_screen.dart';
import 'package:application1/presentation/enter_otp_screen/enter_otp_screen.dart';
import 'package:application1/presentation/home_container_screen/home_container_screen.dart';
import 'package:application1/presentation/search_screen/search_screen.dart';
import 'package:application1/presentation/job_details_tab_container_screen/job_details_tab_container_screen.dart';
import 'package:application1/presentation/message_action_screen/message_action_screen.dart';
import 'package:application1/presentation/chat_screen/chat_screen.dart';
import 'package:application1/presentation/apply_job_screen/apply_job_screen.dart';
import 'package:application1/presentation/notifications_my_proposals_tab_container_screen/notifications_my_proposals_tab_container_screen.dart';
import 'package:application1/presentation/settings_screen/settings_screen.dart';
import 'package:application1/presentation/personal_info_screen/personal_info_screen.dart';
import 'package:application1/presentation/experience_setting_screen/experience_setting_screen.dart';
import 'package:application1/presentation/new_position_screen/new_position_screen.dart';
import 'package:application1/presentation/add_new_education_screen/add_new_education_screen.dart';
import 'package:application1/presentation/privacy_screen/privacy_screen.dart';
import 'package:application1/presentation/language_screen/language_screen.dart';
import 'package:application1/presentation/notifications_screen/notifications_screen.dart';
